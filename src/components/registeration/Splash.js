...
const Splash = () => {
  ...
  const showItem = (e) => {
    ...
    const selectedCar = cars.filter(
      (car) => car.id === parseInt(parent.id, 10)
    )[0];
          ...
          <div className="app-presentation">
            ...
            <div className="app-inf">
              ...
              <p className="app-description">
                ...
                Car rental is perhaps the best solution compared to all the
                other possibilities. High standards of mobility and safety are
                guaranteed. It makes you free from usage of public transport,
                and gives you power to ignore the weather conditions. Moreover,
                it is cheaper than taking a taxi. A rental car makes you free to
                explore all the country, its cities and towns. No matter whether
                you are travelling together as a family or company, for a
                holiday or business,you are welcome to choose any car from our
                collection. We offer weekly and monthly rates. Feel free to sign
                up to get the detailed information.
              </p>
            </div>
          </div>
          <div className="registration-links">
            <Link className="sign up" to="/Sign" state={{ operation: "up" }}>
              SIGN UP
            </Link>
            <Link className="sign in" to="/Sign" state={{ operation: "in" }}>
              LOG IN
            </Link>
          </div>
        </div>
